function eul = Casadirotm2eul( R, varargin )
...
% Pre-allocate output
eul = SX.zeros(3,3); % (size(R,3), 3 , 'like', R); %#ok<PREALL>
...
% Preallocate output
eul = SX.zeros(1, 3); % , size(R,3), 'like', R);  %#ok<PREALL>
